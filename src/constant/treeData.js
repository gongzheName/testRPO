...
export function generateData(x = defaultX, y = defaultY, z = defaultZ, gData = []) {
...
export function calcTotal(x = defaultX, y = defaultY, z = defaultZ) {
